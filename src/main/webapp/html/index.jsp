...
<link rel="stylesheet" type="text/css" href="html/res/datatables-1.10.3/css/jquery.dataTables.css" />
    ...
    $(function() {
      ...
      function retreiveTable(sql){
        ...
        function reloadTable(returnData){
            var tableOptions = $.extend({},tableDefaults,{columns:returnData.column});
